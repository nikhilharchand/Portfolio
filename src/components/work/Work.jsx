...
const Work = () => {
  return (
    <div id="works" className="container m-auto mt-5 bg-black pt-10 pb-12">
      {/* heading */}
      <div 
      data-aos="fade-up"
       className="relative mb-5">
        <h3 className="text-3xl font-black text-white sm:text-2xl">Works</h3>
        <span className="h-[1.1px] right-0 absolute w-[94%] bg-gray-300 block"></span>
      </div>
      <div 
      data-aos="fade-up"
       className="left flex-1 w-full">
        <p className="text-gray-400 font-medium w-[100%]">
